...
public class UrlFragment extends EncodeBaseFragment {
    Context context;
    EditText etUrl;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setBaseContentView(R.layout.fragment_encode_url);
        initView(view);
//        setEnable();
    }
    ...
    public UrlFragment(Context context) {
    ...
    public void encodingClickListener() {
        if (etUrl != null && !etUrl.getText().toString().equals("")) {
            Bitmap bitmap = new QREncode.Builder(context)
                    ...
                    //二维码内容
                    .setContents(etUrl.getText().toString())
                    .setSize(400)//二维码等比大小
